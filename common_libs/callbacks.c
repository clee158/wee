...
size_t char_hash_function(void *elem) { return (size_t) * ((char *)elem); }
...
size_t double_hash_function(void *elem) { return (size_t) * ((double *)elem); }
...
size_t float_hash_function(void *elem) { return (size_t) * ((float *)elem); }
...
size_t int_hash_function(void *elem) { return (size_t) * ((int *)elem); }
...
size_t long_hash_function(void *elem) { return (size_t) * ((long *)elem); }
...
size_t short_hash_function(void *elem) { return (size_t) * ((short *)elem); }
